...
import image1 from "./../assets/Images/motors/image 1.jpg";
import image2 from "./../assets/Images/motors/image 2.jpg";
      ...
      <div className="min-h-[500px]">
        <div className="mx-auto max-w-7xl px-10 lg:px-8">
          ...
          <div className="text-center my-6">
            <h2 className="text-2xl  text-color-red   font-poppins font-medium">
              AC and DC Motors
            </h2>
            <h2 className="text-2xl  text-color-red   font-poppins font-medium">
              AC and DC Motors
